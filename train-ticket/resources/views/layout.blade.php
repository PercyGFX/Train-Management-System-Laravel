...
<div class="super_container">
	...
	<div class="milestones">
		<div class="milestones_background parallax-window" data-parallax="scroll" data-image-src="frontend/images/fact_background.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="section_title text-center">
			...
			<div class="row milestones_container">
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="frontend/images/milestone_1.svg" alt=""></div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="frontend/images/milestone_2.svg" alt=""></div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="frontend/images/milestone_3.svg" alt=""></div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						<div class="milestone_icon"><img src="frontend/images/milestone_4.svg" alt=""></div>
		...
		<div class="container">
			...
			<div class="row icon_box_container">
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="frontend/images/service_1.svg" class="svg" alt="https://www.flaticon.com/authors/monkik"></div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="frontend/images/service_2.svg" class="svg" alt="https://www.flaticon.com/authors/monkik"></div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="frontend/images/service_3.svg" class="svg" alt="https://www.flaticon.com/authors/monkik"></div>
			...
			<div class="row">
				...
				<div class="col-lg-4 footer_col">
					<div class="footer_about">
						...
						<div class="copyright">
Copyright &copy;<script>document.write(new Date().getFullYear());</script> <i class="fa fa-heart-o" aria-hidden="true"></i> <a href="https://www.templateshub.net" target="_blank">Templates Hub</a>
</div>
					</div>
				</div>
					...
					<div class="footer_latest">
						...
						<div class="footer_latest_content">
							...
							<div class="footer_latest_item">
								<div class="footer_latest_image"><img src="frontend/images/latest_1.jpg" alt=""></div>
							...
							<!-- Footer Latest Post -->
							<div class="footer_latest_item">
								<div class="footer_latest_image"><img src="frontend/images/latest_2.jpg" alt=""></div>
								<div class="footer_latest_item_content">
